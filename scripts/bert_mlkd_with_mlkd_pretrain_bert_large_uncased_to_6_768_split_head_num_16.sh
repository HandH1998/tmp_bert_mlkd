...
base_dir1="model/multi_level_distillation/distilled_intermediate_model/bert_mlkd_with_mlkd_pretrain_bert_large_uncased_to_6_768_split_head_num_16"
base_dir2="model/multi_level_distillation/distilled_prediction_model/bert_mlkd_with_mlkd_pretrain_bert_large_uncased_to_6_768_split_head_num_16"
num=0
...
do
    ...
    --student_model "model/distilled_pretrained_model/bert-large-uncased-to-6-768-split-head-num-16" \
    ...
    --do_lower_case \
    --tensorboard_log_save_dir "tensorboard_log/multi_level_distillation/distilled_intermediate_model/bert_mlkd_with_mlkd_pretrain_bert_large_uncased_to_6_768_split_head_num_16/${list_task_name[${num}]}/on_original_data" \
    --gradient_accumulation_steps 1 \
    --split_num 16 \
    --fit_size 1024 \
    > "log/multi_level_distillation/distilled_intermediate_model/bert_mlkd_with_mlkd_pretrain_bert_large_uncased_to_6_768_split_head_num_16/${list_task_name[${num}]}.log" 2>&1 
    ...
    --do_lower_case \
    --tensorboard_log_save_dir "tensorboard_log/multi_level_distillation/distilled_prediction_model/bert_mlkd_with_mlkd_pretrain_bert_large_uncased_to_6_768_split_head_num_16/${list_task_name[${num}]}/on_original_data" \
    --gradient_accumulation_steps 1 \
    --split_num 16 \
    --fit_size 1024 \
    > "log/multi_level_distillation/distilled_prediction_model/bert_mlkd_with_mlkd_pretrain_bert_large_uncased_to_6_768_split_head_num_16/${list_task_name[${num}]}.log" 2>&1 
    let "num++"
done
