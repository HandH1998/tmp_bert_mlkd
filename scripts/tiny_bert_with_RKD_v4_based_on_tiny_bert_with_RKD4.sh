...
base_dir2="model/multi_level_distillation/distilled_prediction_model/tiny_bert_with_RKD_v4_based_on_tiny_bert_with_RKD4"
num=0
...
do
    ...
    --do_lower_case \
    --tensorboard_log_save_dir "tensorboard_log/multi_level_distillation/distilled_prediction_model/tiny_bert_with_RKD_v4_based_on_tiny_bert_with_RKD4/${list_task_name[${num}]}/on_original_data" \
    --gradient_accumulation_steps 1 \
    > "log/multi_level_distillation/distilled_prediction_model/tiny_bert_with_RKD_v4_based_on_tiny_bert_with_RKD4/${list_task_name[${num}]}.log" 2>&1 
    let "num++"
done
