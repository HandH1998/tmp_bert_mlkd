...
base_dir1="model/multi_level_distillation/distilled_intermediate_model/mlkd_bert_speed"
base_dir2="model/multi_level_distillation/distilled_prediction_model/mlkd_bert_speed"
num=0
...
do
    ...
    --do_lower_case \
    --tensorboard_log_save_dir "tensorboard_log/multi_level_distillation/distilled_intermediate_model/mlkd_bert_speed/${list_task_name[${num}]}/on_original_data" \
    --gradient_accumulation_steps 1 \
    --split_num 12 \
    --fit_size 768 \
    > "log/multi_level_distillation/distilled_intermediate_model/mlkd_bert_speed/${list_task_name[${num}]}.log" 2>&1 
    ...
    --do_lower_case \
    --tensorboard_log_save_dir "tensorboard_log/multi_level_distillation/distilled_prediction_model/mlkd_bert_speed/${list_task_name[${num}]}/on_original_data" \
    --gradient_accumulation_steps 1 \
    --split_num 12 \
    --fit_size 768 \
    > "log/multi_level_distillation/distilled_prediction_model/mlkd_bert_speed/${list_task_name[${num}]}.log" 2>&1 
    let "num++"
done
