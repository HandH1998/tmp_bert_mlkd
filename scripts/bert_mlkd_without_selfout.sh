...
list_task_name=("mnli")
list_data_name=("MNLI")
# list_task_name=("cola" "sst-2" "sts-b" "mrpc" "rte" "mnli")
# list_data_name=("CoLA" "SST-2" "STS-B" "MRPC" "RTE" "MNLI")
# distill the intermediate layer with resual knowledge review with enhanced respective fusion
base_dir1="model/multi_level_distillation/distilled_intermediate_model/bert_mlkd_without_selfout"
base_dir2="model/multi_level_distillation/distilled_prediction_model/bert_mlkd_without_selfout"
num=0
...
do
    ...
    # --do_lower_case \
    # --tensorboard_log_save_dir "tensorboard_log/multi_level_distillation/distilled_intermediate_model/bert_mlkd_without_selfout/${list_task_name[${num}]}/on_original_data" \
    # --gradient_accumulation_steps 1 \
    # > "log/multi_level_distillation/distilled_intermediate_model/bert_mlkd_without_selfout/${list_task_name[${num}]}.log" 2>&1 
    ...
    --do_lower_case \
    --tensorboard_log_save_dir "tensorboard_log/multi_level_distillation/distilled_prediction_model/bert_mlkd_without_selfout/${list_task_name[${num}]}/on_original_data" \
    --gradient_accumulation_steps 1 \
    > "log/multi_level_distillation/distilled_prediction_model/bert_mlkd_without_selfout/${list_task_name[${num}]}.log" 2>&1 
    let "num++"
done
