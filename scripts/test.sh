# !/bin/bash
# list_task_name=("rte" "mrpc")
# list_data_name=("RTE" "MRPC")
# # distill the intermediate layer with resual knowledge review with enhanced respective fusion
# base_dir1="model/knowledge_review/distilled_intermediate_model/test"
# base_dir2="model/knowledge_review/distilled_prediction_model/test"
# num=0
...
#     --do_lower_case \
#     --tensorboard_log_save_dir "tensorboard_log/distilled_intermediate_model/test/${list_task_name[${num}]}/on_original_data" \
#     --gradient_accumulation_steps 1 \
#     > "log/distilled_intermediate_model/test/${list_task_name[${num}]}.log" 2>&1 
...
#     --do_lower_case \
#     --tensorboard_log_save_dir "tensorboard_log/distilled_prediction_model/test/${list_task_name[${num}]}/on_original_data" \
#     --gradient_accumulation_steps 1 \
#     > "log/distilled_prediction_model/test/${list_task_name[${num}]}.log" 2>&1 
#     let "num++"
# done
