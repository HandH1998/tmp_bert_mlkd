...
def main():
    ...
    parser.add_argument(
        "--model_name_or_path",
        default='../model/pytorch_bert_base_uncased/pytorch_model.bin',
        type=str,
        required=True,
    ...
    parser.add_argument(
        "--output_dir",
        default='../model/MRPC/pytorch_output/pytorch_model.bin',
        type=str,
        required=True,
